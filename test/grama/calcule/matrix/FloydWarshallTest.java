...
public class FloydWarshallTest {
    ...
    public void resolveTest() {
        System.out.println("ResolveTest");
        ...
        FloydWarshall f = new FloydWarshall(0, new FloydWarshall.Couple(null, null)).initKilometrage(graphmap);
        ...
        f.resolve();
        assertEquals(f.toString().trim(), wanted.trim());
        ...
        f = new FloydWarshall(0, new FloydWarshall.Couple(null, null)).initKilometrage(graphmap);
        ...
        assertEquals(f.resolve().toString().trim(), wanted);
        ...
        assertEquals("getInstance()", f.resolve().toString().trim(), wanted);
    }
